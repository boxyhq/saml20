...
// Tests Configuration
var validToken = fs
  .readFileSync('./test/assets/saml20.validToken.xml')
  .toString();
var invalidToken = fs
  .readFileSync('./test/assets/saml20.invalidToken.xml')
  .toString();
var invalidWrappedToken = fs
  .readFileSync('./test/assets/saml20.invalidWrappedToken.xml')
  .toString();
